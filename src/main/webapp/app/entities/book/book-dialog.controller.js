(function() {
    ...
    BookDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Book', 'Author', 'Chapter'];

    function BookDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Book, Author, Chapter) {
        var vm = this;
